...
var THead = React3.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React3.createElement(Box2, __spreadProps(__spreadValues({}, safelySpreadBoxProps2(props)), {
    ref,
    as: "thead",
...
var TBody = React4.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React4.createElement(Box3, __spreadProps(__spreadValues({}, safelySpreadBoxProps3(props)), {
    ref,
    as: "tbody",
...
var TFoot = React5.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React5.createElement(Box4, __spreadProps(__spreadValues({}, safelySpreadBoxProps4(props)), {
    ref,
    as: "tfoot",
    backgroundColor: "colorBackground",
...
var Tr = React6.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React6.createElement(Box5, __spreadProps(__spreadValues(__spreadValues({}, striped), safelySpreadBoxProps5(props)), {
    ref,
    as: "tr",
    borderStyle: "solid",
    borderColor: "colorBorderWeaker",
...
var Td = React7.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React7.createElement(Box6, __spreadProps(__spreadValues({}, safelySpreadBoxProps6(props)), {
    ref,
    as: "td",
    element,
    fontSize: "fontSize30",
...
var Th = React8.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React8.createElement(Box7, __spreadProps(__spreadValues({}, safelySpreadBoxProps7(props)), {
    ref,
    as: "th",
    element,
    fontSize: "fontSize30",
