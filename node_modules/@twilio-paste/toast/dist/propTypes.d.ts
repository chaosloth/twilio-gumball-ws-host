...
export declare const ToastPropTypes: {
    ...
    variant: any;
    i18nDismissLabel: PropTypes.Requireable<string>;
    i18nErrorLabel: PropTypes.Requireable<string>;
    i18nNeutralLabel: PropTypes.Requireable<string>;
    i18nSuccessLabel: PropTypes.Requireable<string>;
    i18nWarningLabel: PropTypes.Requireable<string>;
};
