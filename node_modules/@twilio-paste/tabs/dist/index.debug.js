...
var Tab = React3.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React3.createElement(import_tabs_primitive2.TabPrimitive, __spreadProps(__spreadValues(__spreadValues({}, tab), tabProps), {
    ref
  }), (props) => {
    return /* @__PURE__ */ React3.createElement(import_box2.Box, __spreadProps(__spreadValues(__spreadValues({}, (0, import_box2.safelySpreadBoxProps)(props)), boxStyles), {
      as: "span",
...
var TabList = React4.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React4.createElement(import_tabs_primitive3.TabPrimitiveList, __spreadProps(__spreadValues(__spreadProps(__spreadValues({}, tab), {
    as: import_box3.Box
  }), props), {
    element: elementName,
    ref
...
var TabPanel = React5.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React5.createElement(import_tabs_primitive4.TabPrimitivePanel, __spreadProps(__spreadValues(__spreadValues(__spreadValues({}, tab), tabPanelStyles), props), {
    element: elementName,
    as: import_box4.Box,
    ref
  }), children);
...
var TabPanels = React6.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React6.createElement(import_box5.Box, __spreadProps(__spreadValues({}, (0, import_box5.safelySpreadBoxProps)(props)), {
    element: elementName,
    width: "100%",
    ref
  }), children);
