...
var Tabs = React2.forwardRef((_a, ref) => {
  ...
  const value = React2.useMemo(() => __spreadProps(__spreadValues({}, tab), { orientation: tabOrientation, variant }), [
    ...Object.values(tab),
    tabOrientation,
    variant
  ]);
...
var Tab = React3.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React3.createElement(TabPrimitive, __spreadProps(__spreadValues(__spreadValues({}, tab), tabProps), {
    ref
  }), (props) => {
    return /* @__PURE__ */ React3.createElement(Box2, __spreadProps(__spreadValues(__spreadValues({}, safelySpreadBoxProps(props)), boxStyles), {
      as: "span",
...
var HorizontalTabList = ({ children, element }) => /* @__PURE__ */ React4.createElement(Box3, {
  display: "flex",
...
var VerticalTabList = ({ children, element }) => /* @__PURE__ */ React4.createElement(Box3, {
...
var TabList = React4.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React4.createElement(TabPrimitiveList, __spreadProps(__spreadValues(__spreadProps(__spreadValues({}, tab), {
    as: Box3
  }), props), {
    element: elementName,
    ref
...
var TabPanel = React5.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React5.createElement(TabPrimitivePanel, __spreadProps(__spreadValues(__spreadValues(__spreadValues({}, tab), tabPanelStyles), props), {
    element: elementName,
    as: Box4,
    ref
  }), children);
...
var TabPanels = React6.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React6.createElement(Box5, __spreadProps(__spreadValues({}, safelySpreadBoxProps2(props)), {
    element: elementName,
    width: "100%",
    ref
  }), children);
