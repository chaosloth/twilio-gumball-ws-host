...
var Menu = React.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(import_menu_primitive2.MenuPrimitive, __spreadProps(__spreadValues({}, props), {
    element,
    as: StyledMenu,
    ref
  }));
...
var MenuButton = React2.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React2.createElement(import_menu_primitive3.MenuPrimitiveButton, __spreadProps(__spreadValues({}, props), {
    element,
...
var MenuGroup = React3.forwardRef((_a, ref) => {
  ...
  }, /* @__PURE__ */ React3.createElement(import_box2.Box, __spreadProps(__spreadValues({}, (0, import_box2.safelySpreadBoxProps)(props)), {
    element,
    role: "presentation",
    "aria-label": label,
    textDecoration: "none",
...
var StyledMenuItem = React4.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React4.createElement(import_box3.Box, __spreadProps(__spreadValues(__spreadProps(__spreadValues({}, props.href && (0, import_anchor.secureExternalLink)(props.href)), {
...
var MenuItem = React4.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React4.createElement(import_menu_primitive4.MenuPrimitiveItem, __spreadProps(__spreadValues({}, props), {
    element,
    variant,
    as,
    ref
...
var StyledMenuSeparator = React5.forwardRef((props, ref) => {
  return /* @__PURE__ */ React5.createElement(import_separator.Separator, __spreadProps(__spreadValues({}, props), {
...
var MenuSeparator = React5.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React5.createElement(import_menu_primitive5.MenuPrimitiveSeparator, __spreadProps(__spreadValues({}, props), {
    element,
...
var SubMenuButton = React6.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React6.createElement(import_menu_primitive6.MenuPrimitiveButton, __spreadProps(__spreadValues({}, props), {
    as: StyledMenuItem,
    element,
    ref
