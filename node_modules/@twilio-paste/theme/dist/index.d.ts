...
declare const Theme: {
    ...
    Consumer: ({ children, ...props }: import("./themeConsumer").ThemeConsumerProps) => import("react").ReactElement<any, string | ((props: any) => import("react").ReactElement<any, any> | null) | (new (props: any) => import("react").Component<any, any, any>)>;
};
