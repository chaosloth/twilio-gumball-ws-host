...
var withAnimated = (Component, host2) => {
  ...
  return (0, import_react2.forwardRef)((givenProps, givenRef) => {
    ...
    return /* @__PURE__ */ (0, import_react2.createElement)(Component, __spreadProps(__spreadValues({}, usedProps), {
      ref
    }));
  });
};
...
var SpringContext = (_a) => {
  ...
  const { Provider } = ctx;
  return /* @__PURE__ */ (0, import_react3.createElement)(Provider, {
    value: props
  }, children);
};
...
function makeContext(target, init) {
  Object.assign(target, (0, import_react3.createContext)(init));
...
function useSprings(length, props, deps) {
  ...
  if (propsFn && !deps)
    deps = [];
  const ref = (0, import_react3.useMemo)(() => propsFn || arguments.length == 3 ? new SpringRef() : void 0, []);
...
function useTransition(data, props, deps) {
  ...
  const ref = (0, import_react3.useMemo)(() => arguments.length == 3 ? new SpringRef() : void 0, []);
  ...
  const renderTransitions = (render) => /* @__PURE__ */ (0, import_react3.createElement)(import_react3.Fragment, null, transitions.map((t, i) => {
    const { springs } = changes.get(t) || t.ctrl;
    const elem = render(__spreadValues({}, springs), t.item, t, i);
    return elem && elem.type ? /* @__PURE__ */ (0, import_react3.createElement)(elem.type, __spreadProps(__spreadValues({}, elem.props), {
...
function applyAnimatedValues(instance, props) {
  ...
  const _a = props, { style, children, scrollTop, scrollLeft } = _a, attributes = __objRest(_a, ["style", "children", "scrollTop", "scrollLeft"]);
