...
var Column = React2.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React2.createElement(Box2, __spreadProps(__spreadValues(__spreadValues({}, safelySpreadBoxProps2(props)), ColumnStyles), {
    as,
    element,
    ref
  }), children);
...
Column.propTypes = {
  ...
  offset: ResponsiveProp2(PropTypes2.number),
  span: ResponsiveProp2(PropTypes2.number)
};
export {
  Column,
  Grid
