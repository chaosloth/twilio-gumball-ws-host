...
var Grid = React.forwardRef((_a, ref) => {
  var _b = _a, { as, children, element = "GRID", equalColumnHeights, gutter, marginTop, marginBottom, vertical = false } = _b, props = __objRest(_b, ["as", "children", "element", "equalColumnHeights", "gutter", "marginTop", "marginBottom", "vertical"]);
...
var getColumnStyles = ({
  ...
  const columnStyles = __spreadValues({
...
var Column = React2.forwardRef((_a, ref) => {
  var _b = _a, { as, children, count, element = "COLUMN", gutter, offset, span, stretchColumnContent, vertical } = _b, props = __objRest(_b, ["as", "children", "count", "element", "gutter", "offset", "span", "stretchColumnContent", "vertical"]);
  ...
  return /* @__PURE__ */ React2.createElement(import_box2.Box, __spreadProps(__spreadValues(__spreadValues({}, (0, import_box2.safelySpreadBoxProps)(props)), ColumnStyles), {
    as,
    element,
    ref
  }), children);
...
Column.propTypes = {
  ...
  offset: (0, import_style_props2.ResponsiveProp)(PropTypes2.number),
  span: (0, import_style_props2.ResponsiveProp)(PropTypes2.number)
};
