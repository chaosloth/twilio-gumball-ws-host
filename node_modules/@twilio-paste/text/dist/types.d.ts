...
import type { CursorProperty, OutlineProperty, TextTransformProperty, TransitionProperty, FontVariantNumericProperty } from 'csstype';
import type { CustomTheme } from '@twilio-paste/customization';
import type { Display, OverflowProps, PositionProps, ShadowProps, SpaceProps, TypographyProps, VerticalAlign } from '@twilio-paste/style-props';
...
export declare type TextPseudoStyleProps = {
...
export declare type StyledTextProps = TextProps & {
