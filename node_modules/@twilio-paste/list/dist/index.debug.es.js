...
var List = React.forwardRef((_a, ref) => {
  var _b = _a, { as, children, element = "LIST" } = _b, props = __objRest(_b, ["as", "children", "element"]);
...
var ListItem = React2.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React2.createElement(Text2, __spreadProps(__spreadValues({}, safelySpreadTextProps(props)), {
    as: "li",
    color: "colorText",
    element,
    fontSize: "fontSize30",
...
var OrderedList = React3.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React3.createElement(List, __spreadProps(__spreadValues({}, safelySpreadTextProps2(props)), {
    as: "ol",
    element,
    marginTop,
    marginBottom,
...
var UnorderedList = React4.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React4.createElement(List, __spreadProps(__spreadValues({}, safelySpreadTextProps3(props)), {
    as: "ul",
    element,
    marginTop,
    marginBottom,
