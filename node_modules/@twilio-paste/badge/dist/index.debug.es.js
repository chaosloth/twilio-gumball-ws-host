...
var Badge = React2.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React2.createElement(Box, __spreadValues(__spreadProps(__spreadValues(__spreadValues({}, safelySpreadBoxProps(props)), href ? secureExternalLink(href) : {}), {
    href,
    alignItems: "center",
    as,
    border: "unset",
    ...
    variant,
    ref
  }), badgeStyles), variant === "error_counter" ? /* @__PURE__ */ React2.createElement(ErrorIcon, {
