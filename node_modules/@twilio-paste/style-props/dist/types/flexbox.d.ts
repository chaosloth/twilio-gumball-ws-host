 ...
 */
export declare type AlignItemsOptions = CSS.Globals | CSS.SelfPosition | 'baseline' | 'normal' | 'stretch';
export declare type AlignItems = ResponsiveValue<AlignItemsOptions>;
/**
 ...
 */
export declare type AlignContentOptions = CSS.Globals | CSS.ContentDistribution | CSS.ContentPosition | 'baseline' | 'normal';
export declare type AlignContent = ResponsiveValue<AlignContentOptions>;
/**
 ...
 */
export declare type JustifyItemsOptions = CSS.Globals | CSS.SelfPosition | 'baseline' | 'left' | 'legacy' | 'normal' | 'right' | 'stretch';
export declare type JustifyItems = ResponsiveValue<JustifyItemsOptions>;
/**
 ...
 */
export declare type JustifyContentOptions = CSS.Globals | CSS.ContentDistribution | CSS.ContentPosition | 'left' | 'normal' | 'right';
export declare type JustifyContent = ResponsiveValue<JustifyContentOptions>;
/**
 ...
 */
export declare type FlexWrapOptions = CSS.FlexWrapProperty;
export declare type FlexWrap = ResponsiveValue<FlexWrapOptions>;
export declare type FlexBasisOptions = CSS.FlexBasisProperty<TLengthStyledSystem>;
export declare type FlexBasis = ResponsiveValue<FlexBasisOptions>;
/**
 ...
 */
export declare type FlexDirectionOptions = CSS.FlexDirectionProperty;
export declare type FlexDirection = ResponsiveValue<FlexDirectionOptions>;
/**
 ...
 */
export declare type FlexOptions = CSS.FlexProperty<TLengthStyledSystem>;
export declare type Flex = ResponsiveValue<FlexOptions>;
/**
 ...
 */
export declare type JustifySelfOptions = CSS.Globals | CSS.SelfPosition | 'auto' | 'baseline' | 'left' | 'normal' | 'right' | 'stretch' | string;
export declare type JustifySelf = ResponsiveValue<CSS.Globals | CSS.SelfPosition | 'auto' | 'baseline' | 'left' | 'normal' | 'right' | 'stretch'> | ResponsiveValue<string>;
/**
 ...
 */
export declare type AlignSelfOptions = CSS.Globals | CSS.SelfPosition | 'auto' | 'baseline' | 'normal' | 'stretch' | string;
export declare type AlignSelf = ResponsiveValue<CSS.Globals | CSS.SelfPosition | 'auto' | 'baseline' | 'normal' | 'stretch'> | ResponsiveValue<string>;
/**
 ...
 */
export declare type OrderOptions = CSS.GlobalsNumber;
export declare type Order = ResponsiveValue<OrderOptions>;
/**
 ...
 */
export declare type FlexGrowOptions = CSS.GlobalsNumber;
export declare type FlexGrow = ResponsiveValue<FlexGrowOptions>;
/**
 ...
 */
export declare type FlexShrinkOptions = CSS.GlobalsNumber;
export declare type FlexShrink = ResponsiveValue<FlexShrinkOptions>;
