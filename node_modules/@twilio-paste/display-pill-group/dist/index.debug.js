...
var DisplayPill = React.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(import_box.Box, {
    as: "li",
    listStyleType: "none"
  }, /* @__PURE__ */ React.createElement(import_box.Box, __spreadProps(__spreadValues(__spreadValues({}, (0, import_box.safelySpreadBoxProps)(props)), props.href ? (0, import_anchor.secureExternalLink)(props.href) : {}), {
    ref,
    element,
    as: props.href ? "a" : "div",
    alignItems: "center",
