...
var PaginationItems = React2.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React2.createElement(Box2, __spreadProps(__spreadValues(__spreadValues({}, ULStyles), safelySpreadBoxProps2(props)), {
    ref,
    element,
    as: "ul"
  }), validChildren.map((child, index) => {
    return /* @__PURE__ */ React2.createElement(Box2, __spreadProps(__spreadValues({}, LIStyles), {
...
var PaginationBackArrow = React5.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React5.createElement(PaginationArrowButton, __spreadProps(__spreadValues({}, props), {
    ref,
    as,
    disabled,
    visibleLabel,
  ...
  }, /* @__PURE__ */ React5.createElement(ArrowBackIcon, {
    decorative: false,
    display: "block",
    title: label,
    element: `${element}_ICON`
  })), visibleLabel ? /* @__PURE__ */ React5.createElement(Text, {
    "aria-hidden": "true",
    as: "span",
    color: "inherit",
    marginLeft: "space30",
...
var PaginationForwardArrow = React6.forwardRef((_a, ref) => {
  var _b = _a, { as = "button", element = "PAGINATION_ARROW", disabled, isFocused, isHovered, label, visibleLabel } = _b, props = __objRest(_b, ["as", "element", "disabled", "isFocused", "isHovered", "label", "visibleLabel"]);
  return /* @__PURE__ */ React6.createElement(PaginationArrowButton, __spreadProps(__spreadValues({}, props), {
    ref,
    element: `${element}_BUTTON`,
    as,
    disabled,
    visibleLabel
  }), visibleLabel ? /* @__PURE__ */ React6.createElement(Text2, {
    "aria-hidden": "true",
    as: "span",
    color: "inherit",
    marginRight: "space30",
    ...
    isHovered,
    element: `${element}_ICON_WRAPPER`
  }, /* @__PURE__ */ React6.createElement(ArrowForwardIcon, {
    decorative: false,
    display: "block",
    title: label,
    element: `${element}_ICON`
...
var PaginationArrow = React7.forwardRef((_a, ref) => {
  ...
  return variant === "back" ? /* @__PURE__ */ React7.createElement(PaginationBackArrow, __spreadProps(__spreadValues({}, props), {
    element,
    ref,
    as,
    disabled,
  ...
  })) : /* @__PURE__ */ React7.createElement(PaginationForwardArrow, __spreadProps(__spreadValues({}, props), {
    element,
    ref,
    as,
    disabled,
...
var PaginationLabel = React8.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React8.createElement(Text3, __spreadProps(__spreadValues({}, safelySpreadTextProps(props)), {
    ref,
    element,
    as: "div",
    color: "colorTextWeak",
...
var PaginationEllipsis = React9.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React9.createElement(Text4, __spreadProps(__spreadValues({}, safelySpreadTextProps2(props)), {
    ref,
    element,
    "aria-label": label,
    as: "span",
...
var PaginationNumber = React10.forwardRef((_a, ref) => {
  ...
  handleLinkValidation({ as, href });
  return /* @__PURE__ */ React10.createElement(Box5, __spreadProps(__spreadValues({}, safelySpreadBoxProps4(props)), {
    ref,
    element,
    "aria-label": label,
    ...
    _active: { textDecoration: "none" }
  }), children ? /* @__PURE__ */ React10.createElement(Text5, {
    "aria-hidden": "true",
    as: "span",
    color: "inherit",
    element: `${element}_TEXT`
...
var PaginationNumbers = React11.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React11.createElement(React11.Fragment, null, /* @__PURE__ */ React11.createElement(Box6, __spreadProps(__spreadValues(__spreadValues({}, ULStyles), safelySpreadBoxProps5(props)), {
    element,
    ref,
    as: "ul",
    justifyContent: "center",
    ...
    return /* @__PURE__ */ React11.createElement(Box6, __spreadProps(__spreadValues({}, LIStyles), {
