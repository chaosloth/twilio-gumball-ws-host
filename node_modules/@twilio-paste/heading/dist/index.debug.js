...
var HeadingPropTypes = {
  as: PropTypes.oneOf(["h1", "h2", "h3", "h4", "h5", "h6", "div", "label", "span"]).isRequired,
...
var Heading = React.forwardRef((_a, ref) => {
  var _b = _a, { as, children, display = "block", element = "HEADING", id, marginBottom, variant } = _b, props = __objRest(_b, ["as", "children", "display", "element", "id", "marginBottom", "variant"]);
  return /* @__PURE__ */ React.createElement(import_text.Text, __spreadProps(__spreadValues(__spreadValues({}, (0, import_text.safelySpreadTextProps)(props)), getHeadingProps(variant, marginBottom)), {
    as,
    display,
    element,
    id,
