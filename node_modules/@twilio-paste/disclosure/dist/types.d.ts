...
import type { DisclosurePrimitiveInitialState, DisclosurePrimitveStateReturn, DisclosurePrimitiveProps, DisclosurePrimitiveContentProps } from '@twilio-paste/disclosure-primitive';
export declare type DisclosureVariants = 'contained' | 'default';
