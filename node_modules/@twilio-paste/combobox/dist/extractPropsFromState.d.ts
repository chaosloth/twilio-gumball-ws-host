import type { UseComboboxPrimitiveReturnValue } from '@twilio-paste/combobox-primitive';
import type { ComboboxProps } from './types';
declare type DefaultStateProps = {
...
export declare const extractPropsFromState: ({ state, ...props }: DefaultStateProps & {
    state?: Partial<UseComboboxPrimitiveReturnValue<any>> | undefined;
}) => Partial<UseComboboxPrimitiveReturnValue<any>>;
export {};
//# sourceMappingURL=extractPropsFromState.d.ts.map