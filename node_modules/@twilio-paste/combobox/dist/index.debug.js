...
var ComboboxListboxOption = React5.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React5.createElement(import_box3.Box, __spreadValues(__spreadValues(__spreadProps(__spreadValues({}, (0, import_box3.safelySpreadBoxProps)(props2)), {
    as: "li",
...
var ComboboxItems = ({
  ...
  const uidSeed = (0, import_uid_library.useUIDSeed)();
...
var getDefaultState = ({
  ...
  return (0, import_combobox_primitive.useComboboxPrimitive)(__spreadValues(__spreadValues(__spreadValues(__spreadValues({
    initialSelectedItem,
    items,
...
var Combobox = React9.forwardRef((_a, ref) => {
  ...
  const { scrollToIndex, virtualItems, totalSize } = useVirtual({
    ...
    overscan: 4,
    paddingStart: (0, import_theme.remToPx)(theme.space.space30, "number")
  });
  const {
    getComboboxProps,
    getInputProps,
  ...
  return /* @__PURE__ */ React9.createElement(import_box5.Box, {
    position: "relative",
