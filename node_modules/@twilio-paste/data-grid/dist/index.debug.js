...
var require_lodash = __commonJS({
  "../../../../node_modules/lodash.iselement/index.js"(exports, module2) {
...
var h = t.forwardRef((N, n) => {
  ...
  return t.createElement(import_box4.Box, l(c({}, o), { as: e, border: "none", clip: "rect(0 0 0 0)", height: "1px", margin: "spaceNegative10", overflow: "hidden", padding: "space0", position: "absolute", ref: n, textTransform: "none", whiteSpace: "nowrap", width: "1px" }), r);
});
...
var DataGridHeaderSort = (_a) => {
  ...
  return /* @__PURE__ */ React10.createElement(import_button.Button, __spreadValues({
    element,
    variant: "reset",
    size: "reset",
    onClick
    ...
    direction
  }), /* @__PURE__ */ React10.createElement(h, null, i18nLabelDirectionMap[direction]));
};
...
var DataGridBody = React11.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React11.createElement(import_table3.TBody, __spreadProps(__spreadValues({}, props), {
    element,
    ref
  }));
});
...
var DataGridFoot = React12.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React12.createElement(import_table4.TFoot, __spreadProps(__spreadValues({}, props), {
    element,
    ref
  }));
});
