...
var PrimaryIconButton = React2.forwardRef((_a, ref) => {
  var _b = _a, { size, buttonState, fullWidth } = _b, props = __objRest(_b, ["size", "buttonState", "fullWidth"]);
  return /* @__PURE__ */ React2.createElement(Box2, __spreadValues(__spreadValues(__spreadValues({
    ref,
    width: fullWidth ? "100%" : "auto"
...
var loadingStyles3 = merge4(BaseStyles.loading, __spreadProps(__spreadValues({}, baseLoadingStyles), {
...
var disabledStyles3 = merge4(BaseStyles.disabled, __spreadProps(__spreadValues({}, baseDisabledStyles), {
...
var SecondaryButton = React3.forwardRef((_a, ref) => {
  var _b = _a, { size, buttonState, fullWidth } = _b, props = __objRest(_b, ["size", "buttonState", "fullWidth"]);
  return /* @__PURE__ */ React3.createElement(Box3, __spreadValues(__spreadValues(__spreadValues({
    ref,
    width: fullWidth ? "100%" : "auto"
...
var SecondaryIconButton = React4.forwardRef((_a, ref) => {
  var _b = _a, { size, buttonState, fullWidth } = _b, props = __objRest(_b, ["size", "buttonState", "fullWidth"]);
  return /* @__PURE__ */ React4.createElement(Box4, __spreadValues(__spreadValues(__spreadValues({
    ref,
    width: fullWidth ? "100%" : "auto"
...
var DestructiveButton = React5.forwardRef((_a, ref) => {
  var _b = _a, { size, buttonState, fullWidth } = _b, props = __objRest(_b, ["size", "buttonState", "fullWidth"]);
  return /* @__PURE__ */ React5.createElement(Box5, __spreadValues(__spreadValues(__spreadValues({
    ref,
    width: fullWidth ? "100%" : "auto"
...
var DestructiveIconButton = React6.forwardRef((_a, ref) => {
  var _b = _a, { size, buttonState, fullWidth } = _b, props = __objRest(_b, ["size", "buttonState", "fullWidth"]);
  return /* @__PURE__ */ React6.createElement(Box6, __spreadValues(__spreadValues(__spreadValues({
    ref,
    width: fullWidth ? "100%" : "auto"
...
var DestructiveLinkButton = React7.forwardRef((_a, ref) => {
  var _b = _a, { size, buttonState, fullWidth } = _b, props = __objRest(_b, ["size", "buttonState", "fullWidth"]);
  return /* @__PURE__ */ React7.createElement(Box7, __spreadValues(__spreadValues(__spreadValues({
    ref,
    width: fullWidth ? "100%" : "auto"
...
var loadingStyles8 = merge9(BaseStyles.loading, __spreadProps(__spreadValues({}, baseLoadingStyles2), {
...
var disabledStyles8 = merge9(BaseStyles.disabled, __spreadProps(__spreadValues({}, baseDisabledStyles2), {
...
var DestructiveSecondaryButton = React8.forwardRef((_a, ref) => {
  var _b = _a, { size, buttonState, fullWidth } = _b, props = __objRest(_b, ["size", "buttonState", "fullWidth"]);
  return /* @__PURE__ */ React8.createElement(Box8, __spreadValues(__spreadValues(__spreadValues({
    ref,
    width: fullWidth ? "100%" : "auto"
...
var LinkButton = React9.forwardRef((_a, ref) => {
  var _b = _a, { size, buttonState, fullWidth } = _b, props = __objRest(_b, ["size", "buttonState", "fullWidth"]);
  return /* @__PURE__ */ React9.createElement(Box9, __spreadValues(__spreadValues(__spreadValues({
    ref,
    width: fullWidth ? "100%" : "auto"
...
var InverseButton = React10.forwardRef((_a, ref) => {
  var _b = _a, { size, buttonState, fullWidth } = _b, props = __objRest(_b, ["size", "buttonState", "fullWidth"]);
  return /* @__PURE__ */ React10.createElement(Box10, __spreadValues(__spreadValues(__spreadValues({
    ref,
    width: fullWidth ? "100%" : "auto"
...
var InverseLinkButton = React11.forwardRef((_a, ref) => {
  var _b = _a, { size, buttonState, fullWidth } = _b, props = __objRest(_b, ["size", "buttonState", "fullWidth"]);
  return /* @__PURE__ */ React11.createElement(Box11, __spreadValues(__spreadValues(__spreadValues({
    ref,
    width: fullWidth ? "100%" : "auto"
...
var ResetButton = React12.forwardRef((_a, ref) => {
  var _b = _a, { size, buttonState, fullWidth } = _b, props = __objRest(_b, ["size", "buttonState", "fullWidth"]);
  return /* @__PURE__ */ React12.createElement(Box12, __spreadValues(__spreadValues(__spreadValues({
    ref,
    width: fullWidth ? "100%" : "auto"
...
var ButtonContents = ({ buttonState, children, showLoading, variant }) => {
  ...
  return /* @__PURE__ */ React13.createElement(React13.Fragment, null, /* @__PURE__ */ React13.createElement(Box13, {
    as: "span",
    display: "flex",
    ...
    columnGap: "space20",
    alignItems: "center"
  }, children), showLoading ? /* @__PURE__ */ React13.createElement(Box13, {
    as: "span",
    position: "absolute",
    top: 0,
    right: 0,
...
var Button = React13.forwardRef((_a, ref) => {
  ...
  if (props.as === "a" && props.href != null && typeof children === "string" && variant !== "reset") {
    injectIconChildren = /* @__PURE__ */ React13.createElement(React13.Fragment, null, children, externalLinkProps != null ? /* @__PURE__ */ React13.createElement(LinkExternalIcon, {
      decorative: false,
      title: i18nExternalLinkLabel
    }) : /* @__PURE__ */ React13.createElement(AnimatedBox, {
      style: arrowIconStyles
    }, /* @__PURE__ */ React13.createElement(ArrowForwardIcon, {
      decorative: true
    })));
  }
  return /* @__PURE__ */ React13.createElement(ButtonComponent, __spreadProps(__spreadValues(__spreadValues({}, externalLinkProps), rest), {
    onMouseEnter: (event) => {
