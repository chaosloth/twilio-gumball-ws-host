...
__export(src_exports, {
  usePasteHighchartsTheme: () => usePasteHighchartsTheme
});
...
var usePasteHighchartsTheme = (options) => {
  if (options == null) {
    throw new Error(`[usePasteHighchartsTheme]: Must provide highcharts options into this function. Options are deepmerged against the theme and returned for usage.`);
  }
  const context = React.useContext(import_styling_library.ThemeContext);
  if (!context) {
    throw new Error("[usePasteHighchartsTheme]: must be used within the @twilio-paste/theme provider. https://paste.twilio.design/introduction/for-engineers/manual-installation#setting-up-the-theme-provider");
  }
