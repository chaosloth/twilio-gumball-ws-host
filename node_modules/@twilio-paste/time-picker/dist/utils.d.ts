 ...
 */
declare type TimeValueType = string;
/**
 * follow https://date-fns.org/v2.21.3/docs/format to define time format
 */
declare type TimeFormatType = string;
/**
 ...
 * @return {*}  {string}
 */
export declare const formatReturnTime: (timeValue: TimeValueType, timeFormat: TimeFormatType) => string;
export {};
